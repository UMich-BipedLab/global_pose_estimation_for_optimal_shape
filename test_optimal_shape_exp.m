...
% 6: vary distance at FRB atrium 7/14/2021 (max 15)
% 7: calibration data 7/14/2021 (max 12)
% 8: mocap data 7/18/2021 (max 18)
% 9: mocap data 7/22/2021 (max 18)
opts.dataset = 6; 
...
target_num_list = 001:018;
target_num_list = [15];

% opts.target_num = 20; % 

opts.target_occlusion = 1;
